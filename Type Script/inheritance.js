...
var Company = /** @class */ (function (_super) {
    ...
    Company.prototype.personDetails = function () {
        console.log(" Name.".concat(this.pname, ",Contact:").concat(this.pcontact, ", Single:").concat(this.psingle, ", Adress:").concat(this.paddress, ", \n            CompanyName:").concat(this.cname, " GST Number:").concat(this.gstnumber, " State:").concat(this.state));
    };
    return Company;
}(oops_1.Person));
var compObj = new Company("VIJAY", 6305340093, "Kerala", true, "Changepond", 12345, "Tamilnadu");
console.log(compObj);
